      ...
      >
        ...
        >
          <a 
            ...
            target="_blank" 
            rel="noopener noreferrer"
            className="inline-flex items-center gap-4 px-8 py-4 rounded-full border-2 border-teal-400/30 bg-gradient-to-r from-black/80 via-teal-950/20 to-black/80 backdrop-blur-xl hover:border-teal-400/60 hover:shadow-[0_0_30px_rgba(45,212,191,0.3)] transition-all duration-300 cursor-pointer"
          >
